      ...
      el.addEventListener('mouseleave', function () {
        ...
        setTimeout(function() {
          if (lookingAtMenuItem == true) {
            ...
            desc.setAttribute('text', 'value', "Look at a new scene and press the cardboard button to view it.");
            lookingAtMenuItem = false;
          };
          //console.log("is looking at menu item " + lookingAtMenuItem)
        ...
        setTimeout(function() {
          if (!lookingAtMenuItem) { desc.setAttribute('text', 'value', "Look at a new scene and press the cardboard button to view it."); };
        }, (delay+400));
      });
    }
  });
